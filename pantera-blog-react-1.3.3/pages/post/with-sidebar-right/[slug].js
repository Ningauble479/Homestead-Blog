...
const ArticleDetailWithSidebarRightScreen = () => {
    ...
    return (
        <Container title={post ? post.title : 'Post detail with sidebar right'}>
            <main className="ps-page ps-page--blog">
                <BreadCrumb source={breadcrumb} />
                <div className="container">
                    <section className="ps-blog--sidebar revered">
...
export default ArticleDetailWithSidebarRightScreen;
